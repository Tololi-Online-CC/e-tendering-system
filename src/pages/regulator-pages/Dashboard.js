    ...
    <div className="dashboard">
        ...
        <div className='all-bids'>
          <div className='all-bids-header'>
            <h2>Pending Bids</h2>
            <Link to={"/contractor/bids_list"} style={{ textDecoration: 'none' }}><span>See all pending <ion-icon name="arrow-forward-outline"></ion-icon></span></Link>
          </div>
        ...
        <div className='all-bids'>
          <div className='all-bids-header'>
            <h2>Users</h2>
            <Link to={"/contractor/bids_list"} style={{ textDecoration: 'none' }}><span>See all users <ion-icon name="arrow-forward-outline"></ion-icon></span></Link>
          </div>
          <div className='dashboard-bid-card'>
            <span>{bid_details[0].id}</span>
            <span>{bid_details[0].attributes.request_title}</span>
