...
export default function Projectpage() {
  ...
  const MyPopUp = () => <div>
    <input type="text" placeholder="Add Title" className="swal2-input" onChange={(e) => setNewEvent({ ...newEvent, title: e.target.value })} />
    <input type="date" className="swal2-input" id="start" onChange={() => setNewEvent({ ...newEvent, start: document.querySelector("#start").value.toISOString() })} />
    <input type="date" className="swal2-input" id="end" onChange={() => setNewEvent({ ...newEvent, end: document.querySelector("#end").value })} />
  </div>
  return (
    <div>
      <Secondhead />
