  ...
  return (
    <div className='regulator-sidebar'>
      <div>
        ...
        <Link to='/regulator/contracts' style={(window.location.pathname === '/regulator/contracts')? background = {borderBottom: '1px solid #ffc90a'}: background = {backgroundColor: '#111111'}}>Contracts</Link>
        ...
        <Link to='/regulator/proposals' style={(window.location.pathname === '/regulator/proposals')? background = {borderBottom: '1px solid #ffc90a'}: background = {backgroundColor: '#111111'}}>Awards</Link>
